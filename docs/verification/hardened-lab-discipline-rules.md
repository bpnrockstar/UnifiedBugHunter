...
>
> The lab is designed to fool a naive operator into filing 4+ N/A reports. The discipline rules in the Unified-Bug-Hunter skill stack should prevent every one of those false claims while still surfacing the real bugs hidden in the lab.
>
