...
> Reproducible end-to-end verification of the Unified-Bug-Hunter stack against a real (deliberately vulnerable) target. Every command below is copy-pasteable. Every result is the actual HTTP response from a live Juice Shop instance — pass or fail.
>
