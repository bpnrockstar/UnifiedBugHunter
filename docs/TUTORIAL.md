...
2. Spin up a deliberately-vulnerable demo target (a YOUR_USER.me lookalike)
...
**YOUR_USER.me — Personal Security Lab** landing screen. That's the target.
...
```bash
python3 tools/validate.py --program YOUR_USER-demo
```
