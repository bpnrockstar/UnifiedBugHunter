...
The Unified-Bug-Hunter bundle maps to a 6-phase workflow that supports both bug hunting and external red-team engagements. Each phase has a focused set of skills; skills compose left-to-right as you move through the workflow, but you can jump in at any phase mid-engagement.
...
The "Source" column in the per-phase tables below tags each skill: **`original`** = author's work in this repo, `community` = community-contributed (v3), `vendored` = from [UnifiedBugHunter](https://github.com/UnifiedBugHunter) (MIT). Of 71 skills: 43 original, 20 community (v3), 8 vendored.
...
- [UnifiedBugHunter](https://github.com/UnifiedBugHunter) — vendored foundation
