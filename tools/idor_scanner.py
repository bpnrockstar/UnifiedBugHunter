...
Usage:
  python3 idor_scanner.py --token-a TOKEN_A --token-b TOKEN_B --report-id REPORT_ID
  python3 idor_scanner.py --token-a TOKEN_A --token-b TOKEN_B --report-id REPORT_ID --user-id USER_ID --program HANDLE
"""
