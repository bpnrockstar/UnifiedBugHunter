#!/usr/bin/env python3
"""
OAuth / Auth Flow Tester
Tests: OAuth state CSRF, redirect_uri bypass, 2FA bypass, pre-account-takeover,
password reset host header injection.

Usage:
  python3 oauth_tester.py --email your@email.com
  python3 oauth_tester.py --check-cors
  python3 oauth_tester.py --check-reset --email your@email.com
"""
