...
Usage:
  python3 race_tester.py --token-a TOKEN --test 2fa
  python3 race_tester.py --token-a TOKEN --token-b TOKEN_B --test bounty --report-id ID
  python3 race_tester.py --token-a TOKEN --test negative-bounty --report-id ID
"""
