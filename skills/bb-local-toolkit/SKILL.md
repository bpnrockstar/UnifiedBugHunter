...
This page only contains the core methodology. Extended reference content (payloads, full tables, detailed examples) has been moved to [`references/`](references/bb-local-toolkit-reference.md) for size management.
