...
Connect Unified Bug Hunter to [Caido](https://caido.io) — the lightweight web security auditing toolkit — via the community [`caido-mcp-server`](https://github.com/c0tton-fluff/caido-mcp-server).
