#!/bin/bash
# Unified Bug Hunter — install skills, commands, and agents for multiple harnesses.
...
install_claude() {
    ...
    echo "Installing Unified Bug Hunter for Claude Code ($SCOPE)..."
...
install_opencode() {
    ...
    echo "Installing Unified Bug Hunter for OpenCode ($SCOPE)..."
    copy_tree_items "skills/*" "$root/skills" "skill"
    copy_files "commands/*.md" "$root/commands" "command"
    copy_files "agents/*.md" "$root/agents" "agent"
    echo "Done: $root"
...
install_pi() {
    ...
    echo "Installing Unified Bug Hunter for Pi Agent ($SCOPE)..."
    copy_tree_items "skills/*" "$root/skills" "skill"
...
install_codex() {
    ...
    echo "Installing Unified Bug Hunter for Codex-style Agent Skills ($SCOPE)..."
    copy_tree_items "skills/*" "$root/skills" "skill"
    copy_files "commands/*.md" "$root/commands" "command"
    echo "Done: $root"
}
