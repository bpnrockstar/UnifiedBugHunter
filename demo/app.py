...
Spins up a small YOUR_USER.me lookalike on http://127.0.0.1:8080 with 6
...
FAKE_ENV = """\
APP_NAME=YOUR_USER.me
DB_HOST=db.internal.YOUR_USER.me
DB_USER=admin
...
<head>
  <meta charset="utf-8">
  <title>YOUR_USER.me — Personal Security Lab</title>
  <style>
...
<body>
  ...
  <nav>
    ...
    <a href="/go?url=https://github.com/YOUR_USER">GitHub</a>
  </nav>
  <form action="/search" method="get">
    <input type="text" name="q" placeholder="Search the lab..." autofocus>
    <button type="submit">Search</button>
  </form>
  <footer>© YOUR_USER.me</footer>
</body>
</html>
"""
...
class DemoHandler(BaseHTTPRequestHandler):
    ...
    def _send(self, status: int, body: bytes, headers: dict) -> None:
        ...
        self.send_header("X-Powered-By", "YOUR_USER/1.0")
        self.end_headers()
    ...
    def do_GET(self):  # noqa: N802
        ...
        if path == "/fetch":
            ...
            try:
                req = urllib.request.Request(target, headers={"User-Agent": "YOUR_USER/1.0"})
